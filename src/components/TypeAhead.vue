		...
		<div v-if="isListVisible" class="simple-typeahead-list">
			...
			<div class="simple-typeahead-list-item"
				...
				<span class="simple-typeahead-list-item-text"
					:data-text="itemProjection(`${item.firstName} ${item.lastName}`)" v-if="$slots['list-item-text']">
					<slot name="list-item-text" :item="item" :itemProjection="itemProjection"
						:boldMatchText="boldMatchText"></slot>
				</span>
				<span class="simple-typeahead-list-item-text"
					:data-text="itemProjection(`${item.firstName} ${item.lastName}`)"
					v-html="boldMatchText(itemProjection(`${item.firstName} ${item.lastName}`))" v-else></span>
			</div>
